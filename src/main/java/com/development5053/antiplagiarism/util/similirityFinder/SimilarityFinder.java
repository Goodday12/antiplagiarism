...
//        System.out.flush();
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        LangSpec spec = finder.getLangSpec(Lang.CPP);
        String code1 = "for(int i = 0; i < 5; ++i); for   (short k=1;k<=7;k++);";
         List<? extends Token> tokens1;
         List<? extends Token> tokens2 = new ArrayList<>();
         List<Integer> encoding1;

        tokens1 = finder.findTokens(code1, spec, Lang.CPP);
